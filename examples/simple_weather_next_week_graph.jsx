...
renderPage(
    <ExamplePage page="simple_weather_next_week_graph">
        <Grapher
            series={makeTemperatureSeries(24, 7 * 24)}
            height={380}
            preset="simple"
            timeZone="America/Los_Angeles"
            currentTime={ANCHOR_TIME + 8 * HOUR_MS}
            yAxisTicks="temperature-f"
            customBoundsSelectors={[boundsSelector('7d', 0, 7 * 24)]}
            defaultBoundsCalculator="7d"
        />
    </ExamplePage>
);
